...
import '../controllers/emp_kashf_tepy_search_report_controller.dart';

class KashfTepyReport extends StatelessWidget {
  const KashfTepyReport({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.find<EmpKashfTepySearchReportController>();
                  ...
                  () {
                    ...
                    return PlutoGrid(
                          ...
                          .map(
                            (item) => PlutoRow(
                              cells: {
                                ...
                                "medicalUnitType": PlutoCell(
                                  value: item.medicalUnitType.getValue(),
                                ),
                                ...
                                "datEnketa3": PlutoCell(
                                  value: item.datEnketa3.getValue(),
                                ),
                              },
                            ),
                          )
                      ...
                      columns: [
                        ...
                        PlutoColumn(
                          title: 'نوع الوحدة الصحية',
                          field: 'medicalUnitType',
                          type: PlutoColumnType.text(),
                        ),
                        PlutoColumn(
                          title: 'اسم الوحدة الصحية',
