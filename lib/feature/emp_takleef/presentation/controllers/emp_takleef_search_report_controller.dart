...
class EmpTakleefSearchReportController extends GetxController {
  final EmpTakleefRepository _repository;

  EmpTakleefSearchReportController(this._repository);

  RxString messageError = "".obs;
  RxBool isLoading = false.obs;

  RxList<EmpTakleefReportModel> empTakleefs = <EmpTakleefReportModel>[].obs;
  ...
  Future<void> report() async {
    ...
    for (EmpTakleefReportModel m in empTakleefs) {
      data.add(
        [
          m.dateBegin ?? "",
          m.hoursPeriodTotal ?? "",
    ...
    final pdf = pw.Document(title: "تقرير بيان تكليف الموظفين");
