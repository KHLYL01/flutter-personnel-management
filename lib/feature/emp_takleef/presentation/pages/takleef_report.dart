...
import '../controllers/emp_takleef_search_report_controller.dart';

class TakleefReport extends StatelessWidget {
  const TakleefReport({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.find<EmpTakleefSearchReportController>();
                  ...
                  () {
                    ...
                    return PlutoGrid(
                          ...
                          .map(
                            (item) => PlutoRow(
                              cells: {
                                ...
                                "place": PlutoCell(
                                  value: item.place.getValue(),
                                ),
                                "task": PlutoCell(
                                  value: item.task.getValue(),
                                ),
                                "period": PlutoCell(
                                  value: item.period.getValue(),
                                ),
                                "hoursPeriodTotal": PlutoCell(
                                  value: item.hoursPeriodTotal.getValue(),
                                ),
                                "dateBegin": PlutoCell(
                      ...
                      columns: [
                        ...
                        PlutoColumn(
                          title: 'عدد ايام التكليف',
                          field: 'period',
                          type: PlutoColumnType.text(),
                        ),
                        PlutoColumn(
                          title: 'مجموع ساعات التكليف',
                          field: 'hoursPeriodTotal',
                          type: PlutoColumnType.text(),
                        ),
                        PlutoColumn(
                          title: 'تاريخ بداية التكليف',
                          field: 'dateBegin',
                          type: PlutoColumnType.text(),
                        ),
                      ],
