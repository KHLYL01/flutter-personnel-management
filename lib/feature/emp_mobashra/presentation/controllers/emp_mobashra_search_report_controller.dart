...
class EmpMobashraSearchReportController extends GetxController {
  final EmpMobashraRepository _repository;

  EmpMobashraSearchReportController(this._repository);

  RxString messageError = "".obs;
  RxBool isLoading = false.obs;

  RxList<EmpMobashraReportModel> empMobashras = <EmpMobashraReportModel>[].obs;
  ...
  Future<void> report() async {
    ...
    for (EmpMobashraReportModel m in empMobashras) {
      data.add(
        [
          m.datMobashra ?? "",
          m.naqlBadal ?? "",
    ...
    final pdf = pw.Document(title: "تقرير مباشرة");
