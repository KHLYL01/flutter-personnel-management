...
class EmpHasmiatSearchReportController extends GetxController {
  final EmpHasmiatRepository _repository;

  EmpHasmiatSearchReportController(this._repository);

  RxString messageError = "".obs;
  RxBool isLoading = false.obs;

  RxList<EmpHasmiatReportModel> empHasmiats = <EmpHasmiatReportModel>[].obs;
  ...
  Future<void> report() async {
    ...
    for (EmpHasmiatReportModel m in empHasmiats) {
      data.add(
        [
          m.gza ?? "",
          m.tagmee3 ?? "",
    ...
    final pdf = pw.Document(title: "تقرير بيان حسميات و جزاءات الموظفين");
...
""",
                    ...
                    pw.Text(
                      "تقرير بيان حسميات و جزاءات الموظفين",
                      textAlign: pw.TextAlign.center,
                      style: pw.TextStyle(
                        font: arabicFont,
                        fontSize: 8,
