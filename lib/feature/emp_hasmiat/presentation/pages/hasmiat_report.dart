...
import '../controllers/emp_hasmiat_search_report_controller.dart';

class HasmiatReport extends StatelessWidget {
  const HasmiatReport({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.find<EmpHasmiatSearchReportController>();
                          ...
                          .map(
                            (item) => PlutoRow(
                              cells: {
                                ...
                                "ghyab":
                                    PlutoCell(value: item.ghyab.getValue()),
                                "tagmee3":
                                    PlutoCell(value: item.tagmee3.getValue()),
